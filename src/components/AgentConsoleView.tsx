...
export const AgentConsoleView: React.FC = () => {
  ...
  const samplePrompts = [
    {
      label: 'Safe: Generate Sales Report',
      text: 'Generate an executive sales report summary',
    },
    {
      label: 'Safe: Read Sales File',
      ...
      <div className="flex flex-wrap gap-2.5">
        {samplePrompts.map((p, idx) => (
          <motion.button
            ...
            className="px-3.5 py-2 bg-[#070c18] hover:bg-[#0d1629] border border-[#182642] hover:border-[#1e2e54] text-xs text-slate-300 hover:text-white rounded-xl flex items-center space-x-2 transition-all font-mono shadow-sm cursor-pointer"
          >
